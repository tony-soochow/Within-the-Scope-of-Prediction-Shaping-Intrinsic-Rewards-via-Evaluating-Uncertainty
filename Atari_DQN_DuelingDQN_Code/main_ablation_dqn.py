...
def optimize_model():
    ...
    ri = predictor.compute_reward(compute_reward_batch)
...
def train(env, total_count, render=False):
    ...
    total_reward = 0.0
    t = 0
    for count in range(total_count): #500w
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', default='q.csv') #../results/Boxing_DQN.csv
    ...
    predictor = PredictorAgent(act_size=1, ri_climap=args.riclimp).to(device)
